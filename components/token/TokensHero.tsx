...
interface TokensHeroProps {
    ...
    tokenHaveLiquidity: number;
    tokenFound: boolean;  // Add this prop to indicate if a token was found
}

const TokensHero = ({ onSearch, totalTokenCreated, tokenHaveLiquidity, tokenFound }: TokensHeroProps) => {
        ...
        <div className="min-h-40 max-w-full flex flex-col gap-4 text-gray-100 md:flex-row items-center p-6">
            ...
            <div className="w-full text-gray-500">
                <form className="relative">
                    <input
                        type="text"
                        placeholder="Search for a ticker, contract address, or token name..."
                        value={searchQuery}
